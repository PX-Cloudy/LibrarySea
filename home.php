...
<link rel="icon" href="src/LibrarySea/img/LibrarySeaLogo16X16.ico" type="image/x-icon" />
<link rel="shortcut icon" href="src/LibrarySea/img/LibrarySeaLogo16X16.ico" type="image/x-icon" />
<style type="text/css">
.menubar {
  clear: both;
  border-radius: 8px;
...
<table width=100% class="menubar"><tr>
  <td width=100%>
  <div class="toolbar">
    <a href="src/home.php">主页</a>
    <a href="LibrarySea/src/MenuBar/ProgramLanguage.php">开发语言</a>
    <a href="LibrarySea/src/MenuBar/Application.php">应用领域</a>
    <a href="LibrarySea/src/MenuBar/UML.php">UML</a>
    <a href="LibrarySea/src/MenuBar/SourceCode.php">源码</a>
    <a href="LibrarySea/src/MenuBar/Algorithm.php">算法</a>
    <a href="LibrarySea/src/MenuBar/DesignPatterns.php">设计模式</a>
    <a href="LibrarySea/src/MenuBar/UpdateNews.php">更新</a>
    <a href="LibrarySea/src/MenuBar/Links.php">官网链接</a>
    <a href="LibrarySea/src/MenuBar/About.php">关于</a>
  </div>
<script>
